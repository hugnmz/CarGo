...
<html lang="vi">
  <head>
    ...
    />
    <link
      href="${pageContext.request.contextPath}/css/customer/my-contracts.css"
      rel="stylesheet"
    />
  </head>
  <body>
                    ...
                    <div class="col-lg-6 mb-3 mb-lg-0">
                      ...
                      >
                        <div>
                          ...
                          <c:set
                            var="statusClass"
                            value="${c.status == 'PENDING' ? 'status-pending' : c.status == 'ACCEPTED' ? 'status-accepted' : c.status == 'IN_PROGRESS' ? 'status-in-progress' : c.status == 'COMPLETED' ? 'status-completed' : 'status-cancelled'}"
                          />
