    ...
    <head>
        ...
        <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .navbar-modern .btn-primary-custom {
            ...
            .navbar-modern .btn-primary-custom:hover {
            ...
            .search-modern .form-control, .search-modern .form-select {
                border: 2px solid #e5e7eb;
                padding: 0.75rem 1rem;
                border-radius: 10px;
                transition: all 0.3s;
            }
            .search-modern .form-control:focus, .search-modern .form-select:focus {
            ...
            .car-card-modern .card-img-top {
                height: 220px;
                object-fit: cover;
                transition: all 0.3s;
            }
            .car-card-modern:hover .card-img-top {
                transform: scale(1.05);
            }
            .car-card-modern .badge-modern {
                background: var(--primary);
                color: white;
            ...
            .car-card-modern .price-modern {
                font-size: 1.75rem;
                font-weight: 700;
                color: var(--primary);
            }
            .car-card-modern .price-old {
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="${pageContext.request.contextPath}/admin/user.jsp"><i class="fas fa-user me-2"></i>Thông tin cá nhân</a></li>
