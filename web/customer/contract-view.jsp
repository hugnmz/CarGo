...
<html lang="vi">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/customer/contract-view.css?v=2" rel="stylesheet" />
            ...
            <div class="page-header">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h1 class="h2 mb-2">
                                <i class="fas fa-file-contract me-2"></i>Hợp đồng #${contract.contractId}
                            </h1>
                        ...
                        <div class="d-flex gap-2 mt-3 mt-md-0 toolbar">
                            ...
                            <button type="button" class="btn btn-back btn-print" onclick="window.print()">
                    ...
                    <div class="col-lg-4">
                        <div class="info-card mb-3">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value">${contract.startDate.toLocalDate()}</span>
                            </div>
                ...
                <div class="row g-4 mt-1">
                    <div class="col-12">
                        <div class="terms-card">
                            <h5><i class="fas fa-scale-balanced me-2"></i>Điều khoản & Cam kết</h5>
                            <ol class="terms-list">
                                <li>Bên thuê sử dụng xe đúng mục đích, không chở hàng cấm, không cho thuê lại.</li>
                                <li>Không điều khiển xe vào khu vực ngập nước, đường bị cấm, đường nguy hiểm; nếu vi phạm tự chịu trách nhiệm chi phí sửa chữa và tổn thất phát sinh.</li>
                                <li>Thời gian thuê tính theo hợp đồng. Trễ giờ trả xe: phụ thu 100.000đ/giờ; vượt km: 3.000đ/km.</li>
                                <li>Xe nhận với mức xăng ghi nhận trong hợp đồng, khi trả xe bổ sung tương đương (hoặc tính thêm theo thực tế).</li>
                                <li>Mọi vi phạm giao thông trong thời gian thuê do Bên thuê chịu trách nhiệm nộp phạt.</li>
                                <li>Đặt cọc hoàn lại sau khi thanh lý hợp đồng (trừ các chi phí phát sinh nếu có).</li>
