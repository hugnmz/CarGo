                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="profile-info">
                            <div class="profile-content">
                                ...
                                <!-- Thêm vào sau phần success message -->
                                ...
                                <form action="${pageContext.request.contextPath}/CustomerServlet" method="POST" id="profileForm">
                                    <input type="hidden" name="isVerified" value="${not empty customer.isVerified ? customer.isVerified : 'true'}">
                                    ...
                                    <div class="profile-details">
                                        ...
                                        <input type="hidden" name="username" value="${not empty customer.username ? customer.username : sessionScope.username}">
