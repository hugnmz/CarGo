...
<<<<<<< HEAD:web/customer/car-detail.jsp
...
>>>>>>> origin/main:web/car-detail.jsp
    </head>
    <body>
        <!-- Navbar -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/ViewCartDetail?carId=${car.carId}&vehicleId=${param.vehicleId}">
                            ...
                            <form action="${pageContext.request.contextPath}/customer/booking-form.jsp" method="get">
                                ...
                                <div class="mb-3" id="vehicleSelectContainer">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        Vui lòng chọn ngày nhận/trả để hiển thị xe có sẵn
                                    </small>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/customer/booking-form.jsp" method="get" class="d-grid">
                                                        ...
                                                        <button type="submit" class="btn add-to-cart-btn w-100">
                                                            <i class="fa fa-calendar me-2"></i>Đặt xe
                                                            </button>
                                                        </form>
                                                    </c:when>
                                                    <c:otherwise>
        ...
        <script>
            (function() {
                ...
                async function loadVehicles() {
                    ...
                    const e = endEl.value;
                    btn.disabled = true;
                    sel.innerHTML = '<option value="">-- Chọn biển số xe --</option>';
                    sel.disabled = true;
                    toggle(noAlert, false);
                    ...
                    try {
                        ...
                        if (Array.isArray(data) && data.length > 0) {
                            data.forEach(v => {
                                ...
                                opt.textContent = `${v.plateNumber}${v.city ? ' - ' + v.city : ''}`;
                                sel.appendChild(opt);
                            });
                            sel.disabled = false;
                            btn.disabled = false;
