...
//
//        try {
//            Optional<UseDTO> adminOpt = userService.loginUser(username, password);
//
//            if (adminOpt.isPresent()) {
//                UseDTO admin = adminOpt.get();
//
...
//    }
//
//    private void setSessionAttributes(HttpSession session, UseDTO admin) {
