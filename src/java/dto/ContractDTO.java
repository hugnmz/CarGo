...
public class ContractDTO {
    ...
    public String getStartDateToString(){return startDate.format(formatter);}
    
    public LocalDateTime getEndDate() { return endDate; }
    public void setEndDate(LocalDateTime endDate) { this.endDate = endDate; }
    public String getEndDateToString(){return endDate.format(formatter);}
    ...
    public String getCreateAtToString(){ return createAt.format(formatter);}
